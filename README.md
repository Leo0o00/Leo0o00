...
I'm a Backend Developer. <br>I have developed applications in several technologies such as .NET, Golang, SpringBoot, Nest.js, Next.js, Node.js with Express. <br>I also have experience using data persistence technologies like Postgres, MySQL, MongoDB and Redis. Architecting event driven applications based in architectures like microservices and modularized monoliths using RabbitMQ, Kafka and Amazon SQS. Implementing design patterns and layered programming techniques for clean, scalable and easily maintainable code structures.<br>
